...
function spawnObstacle() {
  ...
  img.src = './mario-jump-images/pipe.png'; // Define a imagem do cano
...
function gameOver(hitPipe){
  ...
  mario.src = './mario-jump-images/game-over.png'; // Troca a imagem para a versão "game over"
...
function restartGame(){
  ...
  mario.src = './mario-jump-images/mario.gif'; // Volta para a imagem animada do Mario
